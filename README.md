...
- GitHub Pages 화면 기준 Protein Note, 프로젝트 폴더, 최근 본 단백질
- Pro 리포트 미리보기, Markdown 복사/저장, PDF 인쇄
- 근거 문장별 논문 링크 추적
- 상태별 구조 비교, 변이 입력 기반 해석 포인트, 자세히 보기
- 추천 단백질 랜덤 카드
...
- FoldNote 앱 코드, UI, 제품명, 원문 카피는 별도 허가 없이 복제, 재배포, 판매, 재호스팅할 수 없습니다.
